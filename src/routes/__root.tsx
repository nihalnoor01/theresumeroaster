...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload your resume and get brutally honest AI feedback plus instant rewrites. Free, no signup, nothing stored." },
      { name: "author", content: "Medium Rare Hire" },
      { property: "og:title", content: "Medium Rare Hire — Brutally honest AI resume feedback" },
      { property: "og:description", content: "Upload your resume and get brutally honest AI feedback plus instant rewrites. Free, no signup, nothing stored." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Medium Rare Hire" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Medium Rare Hire — Brutally honest AI resume feedback" },
      { name: "twitter:description", content: "Upload your resume and get brutally honest AI feedback plus instant rewrites. Free, no signup, nothing stored." },
